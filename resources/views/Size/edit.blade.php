...
<!-- Include Bootstrap Tags Input JavaScript -->
                        ...
                        <form method="POST" action="{{ route('size.update',$size->id) }}">
                           ...
                           @method('PUT')
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" placeholder="Enter size" name="size" id="input" data-role="tagsinput" value="{{ old('size', $size->size) }}"  required>
