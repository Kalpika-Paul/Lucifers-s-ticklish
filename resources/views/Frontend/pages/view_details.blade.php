                    ...
                    <div class="product-options">
                        <label>
                            ...
                            <select class="input-select">
                                <option value="0">{{$products->size->size}}</option>
                            </select>
                        </label>
                        <label>
                            Color
...
<div class="section">
    ...
    <div class="container">
        ...
        <div class="row">
           ...
           @foreach ($retaled_products as $retaled_product) 
            ...
            <div class="col-md-3 col-xs-6">
                <div class="product">
                    ...
                    <div class="product-body">
                        <p class="product-category">{{ $retaled_product->category->name }}</p>
                        <h3 class="product-name"><a href="#">{{ $retaled_product->name }}</a></h3>
                        <h4 class="product-price">{{ $retaled_product->price }} <del class="product-old-price">$990.00</del></h4>
                        <div class="product-rating">
                        </div>
